...
public class RedisService {
     ...
     * @return
     */
    public Boolean hmHas(String key, Object hashKey) {
        HashOperations<String, Object, Object> hash = redisTemplate.opsForHash();
     ...
     * @return
     */
    public Set<Object> reverseRange(String key, long start, long end, double startScore, double endScore) {
        ZSetOperations<String, Object> zset = this.redisTemplate.opsForZSet();
        return zset.reverseRangeByScore(key, startScore, endScore, start, end);
    }

    /**
     * @Author : HJK
     * @Description : 统计有序集合数量
     * @Params:
     * @Date : 2019/5/27
     */
    public long rangeSize(String key) {
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
     ...
     * @Date : 2019/5/27
     */
    public long rangeSize(String key, double startScore, double endScore) {
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
        Long count = zset.count(key, startScore, endScore);
        if (null == count) {
            return 0L;
        }
        return count;

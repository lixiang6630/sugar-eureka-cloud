...
public class HttpClientUtil {
    ...
    public static final int CONNECTION_TIMEOUT_MS = 5000;//5秒
    ...
    public static RequestConfig genRequestConfig(int connectTimeout,int reqTimeout) {
        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(reqTimeout)
    ...
    public static String post(String url,String bodyJsonStr) throws URISyntaxException, IOException {
        return post(url, null,bodyJsonStr, UTF8);
    }

    public static String post(String url,Map<String,String> headerMap,String bodyJsonStr) throws URISyntaxException, IOException {
        return post(url, headerMap,bodyJsonStr, UTF8);
    }

    public static String post(String url,Map<String,String> headerMap,String bodyJsonStr,int connectTimeout,int reqTimeout) throws URISyntaxException, IOException {
        return post(url, headerMap,bodyJsonStr, UTF8,connectTimeout,reqTimeout);
    }

    public static String post(String url, Map<String,String> headerMap,String bodyJsonStr, String charset) throws URISyntaxException , IOException {

        return post(url, headerMap,bodyJsonStr, charset,CONNECTION_TIMEOUT_MS,SO_TIMEOUT_MS);
    }

    public static String post(String url, Map<String,String> headerMap,String bodyJsonStr, String charset,int connectTimeout,int reqTimeout) throws URISyntaxException , IOException {

        HttpPost postMethod = genHttpPost(url, bodyJsonStr);
        postMethod.setConfig(genRequestConfig(connectTimeout,reqTimeout));
        if(headerMap!=null && headerMap.size()>0) {
            for(String key:headerMap.keySet()) {
                postMethod.setHeader(key,headerMap.get(key));
            }
        }
        String returnStr=null;
        try{
